...
var _MonthYearSwitch = __webpack_require__(60);

var _MonthYearSwitch2 = _interopRequireDefault(_MonthYearSwitch);

var _getCalendarMonthWeeks = __webpack_require__(45);
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement('div', { className: calendarMonthClasses, 'data-visible': isVisible }, _react2['default'].createElement('table', null, _react2['default'].createElement('caption', { className: 'CalendarMonth__caption js-CalendarMonth__caption' }, isYearsEnabled ? _react2['default'].createElement(_MonthYearSwitch2['default'], {
          ...
          navNext: navNext,
          navPrev: navPrev
        }) : _react2['default'].createElement('strong', null, monthTitle)), _react2['default'].createElement('tbody', { className: 'js-CalendarMonth__grid' }, weeks.map(function (week, i) {
